...
local UI_LOCALE = {
    enUS = {
        ...
        ANIMATION_ICON_MODE_HINT = "No-pet/dead-pet show the matching spell icon. Passive/Defensive show the pet stance icon (requires pet alive). Unknown state has no icon.",
