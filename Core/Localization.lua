...
local UI_LOCALE = {
    ...
    ruRU = {
        ...
        ANIMATION_ICON_MODE_HINT = "Состояния «нет питомца» и «питомец мёртв» — значок нужного заклинания призыва. Пассивный/Защита — значок стойки питомца (требуется живой питомец). Неизвестный статус — без значка.",
